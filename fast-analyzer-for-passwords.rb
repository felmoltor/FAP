...
def parseOptions
   ...
   #     opt.on('-v (0,1,2,3)','--verbose (0,1,2,3)',:w,'Level of verbosity (1: Display percentage, 2: Display 1 of every 10 analyzed passwords, 3: Display every password analyzed') do |level|
     #       opts[:verbose] = level
    #    end
...
if gruffinstalled
    ...
    strength_histogram.write("password-strength-histogram.png")
end
...
if gruffinstalled
  ...
  labelindex = 0
    ...
    len_histogram.write('password-length-histogram.png')
end
puts "============"
